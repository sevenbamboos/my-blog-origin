...
24.delegate as Func and Action in System namespace | delegate acts as class (generated by compiler) captured surrounding variables, used like `public delegate void Foo(); Foo aDelegate = methodName, aDelegate += anotherMethodName` Note Foo can be delcared by System.Action, which is `delegate void Action();`. Also note delegate can be multicast.
