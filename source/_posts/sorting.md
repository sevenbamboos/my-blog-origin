...
So I'm curious to know how good the built-in sort is and whether my home-made sort can defeat it. It sounds like playing with AlphaGo, but I still decide to have a go. For the completeness, I include elementary sorting methods:select sort, insert sort and shell sort, which have the performance of {% asset_img "o_n_2.png" "" %}, as well as more advanced sort:heap sort, merge sort and quick sort with the performance of {% asset_img "o_n_lgn.png" "" %}. Here is the detailed source code.
